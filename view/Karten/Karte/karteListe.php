    ...
    ?>
    <div class="main3">
        <h1 class="p-3 primetitle text-light">Die Kartensorten</h1>
    </div>
    <div class="main2">
        <button class="openbtn" onclick="openNav()">☰</button>
        <h1 class="p-3 primetitle text-light">Die Kartensorten</h1>
    </div>
    <h2>Es gibt verschiedene Kartentypen. <br>Nachfolgend finden Sie ein Beispiel für jeden Kartentyp.</h2>
    <h3>Wenn Sie mit der Maus über die Karten fahren, stehen Ihnen anklickbare Links zur Verfügung. Damit können Sie nach Belieben erkunden.</h3>
