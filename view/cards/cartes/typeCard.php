                ...
                ?>
                                                    <div class="present2 present">
                                                        ...
                                                        <div class="infosTypeCard">
                                                            ...
                                                            <div class="niveau">
                                                                <p class="card-text"><a class="link-light"
                                                                        href="index.php?ctrl=card&action=detaillevel&level=<?= $card['level'] ?>" target="_blank"> Niveau <?= $card['level'] ?></a></p>
                                                            </div>
                                                            <div class="element">
                                                                <p class="card-text"><a class="link-light" 
                                                                        href="index.php?ctrl=card&action=detailElement&attribute=<?= $card['attribute'] ?>" target="_blank">Elément <?= $card['attribute'] ?> </a></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php
                ...
                ?>
                                                    <div class="present2 present">
                                                        ...
                                                        <div class="infosTypeCard">
                                                            ...
                                                            <div class="niveau">
                                                                <p class="card-text"><a class="link-light" 
                                                                        href="index.php?ctrl=card&action=detailscale&scale=<?= $card['scale'] ?>" target="_blank">Echelle Pendule :
                                                                    <?= $card['scale'] ?></a>
                                                                </p>
                                                            </div>
                                                            <div class="element">
                ...
                ?>
                                                    <div class="present2 present">
                                                        ...
                                                        <div class="infosTypeCard">
                                                            <div class="titre">
                                                                <h5 class="card-title"><a class="link-light"
                                                                        href="index.php?ctrl=card&action=detailcard&id=<?= $card['id'] ?>" target="_blank"> <?= $card['name'] ?></a></h5>
                                                            </div>
                                                            <div class="type2">
                                                                <p class="card-text"><a class="link-light"
                                                                        href="index.php?ctrl=card&action=detailtype&type=<?= $card['type'] ?>" target="_blank"> <?= $card['type'] ?></a></p>
                ...
                ?>
                                                    <div class="present2 present">
                                                        ...
                                                        <div class="infosTypeCard">
                                                            ...
                                                            <div class="niveau">
                                                                <p class="card-text"><a class="link-light"
                                                                        href="index.php?ctrl=card&action=detailrace&race=<?= $card['race'] ?>" target="_blank"><?= $card['race'] ?> </a> </p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <?php
                ...
                ?>
                                                    <div class="present2 present">
                                                        ...
                                                        <div class="infosTypeCard">
                                                            ...
                                                            <div class="niveau">
                                                                <p class="card-text">
                                                                    <a class="link-light" href="index.php?ctrl=card&action=detailLinkval&linkval=<?= $card['linkval'] ?>" target="_blank"> Valeur lien : <?= $card['linkval'] ?> </a>
                                                                </p>    
                                                            </div>
                                                            <div class="element">
                                                                <p class="card-text"><a class="link-light" 
